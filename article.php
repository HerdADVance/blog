...
<body class="is-article">
	...
	<div class="article-image" style="background-image:url(/assets/images/vikes-panthers.jpg);"></div>
	<div class="parallax">
		<article class="article">
			
			<header class="article-header wrap-bg flex">
				<div class="article-header-text">
					<h1 class="article-header-title">What the fuck is going on in Huntington? I mean like seriously this needs to be a longer headline so here we go</h1>
					<div class="article-header-byline">
						By: <strong class="article-header-author">Alex Vance</strong> on 
						<time datetime="2019-07-02" class="article-header-date">July 13, 2019</time>
			...
			<main class="wrap-bg">
				...
				<p><img src="/assets/images/vikes-panthers.jpg"></p>
		...
		<section class="wrap-pad related-articles">
			<h1 class="section-title white-text">Related Articles</h1>
			<div class="related-articles-wrap">
				<div class="related-article">
					<a href="/article.php">
						<div class="related-article-image" style="background-image:url(/assets/images/siesta-key-sunset.jpg);"></div>
						<h2 class="related-article-title">Not Good For Bubbers</h2>
					</a>
				</div>
				<div class="related-article">
					<a href="/article.php">
						<div class="related-article-image" style="background-image:url(/assets/images/vesuvius-2.jpg);"></div>
						<h2 class="related-article-title">Surprisingly, No Ohioans Have Driven into this Lake</h2>
					</a>
				</div>
				<div class="related-article">
					<a href="/article.php">
						<div class="related-article-image" style="background-image:url(/assets/images/winston-salem-snow.jpg);"></div>
						<h2 class="related-article-title">What the hell? Why is it snowing in North Carolina in early December?</h2>
					</a>
				</div>
			</div>
		</section>
